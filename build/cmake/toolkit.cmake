...
if(wxUSE_GUI)
    ...
    if(WXQT)
        set(QT_COMPONENTS Core Widgets Gui OpenGL Test OpenGLWidgets)

        foreach(QT_COMPONENT ${QT_COMPONENTS})
            find_package(Qt6 COMPONENTS ${QT_COMPONENT} REQUIRED)
            list(APPEND wxTOOLKIT_INCLUDE_DIRS ${Qt6${QT_COMPONENT}_INCLUDE_DIRS})
            list(APPEND wxTOOLKIT_LIBRARIES ${Qt6${QT_COMPONENT}_LIBRARIES})
            list(APPEND wxTOOLKIT_DEFINITIONS ${Qt6${QT_COMPONENT}_COMPILE_DEFINITIONS})
        endforeach()

        set(wxTOOLKIT_VERSION ${Qt6Core_VERSION})
    endif()
